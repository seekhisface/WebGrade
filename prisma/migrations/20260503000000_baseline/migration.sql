...
-- CreateEnum
CREATE TYPE "CtaType" AS ENUM ('DEMO', 'SIGNUP', 'TRIAL', 'CONTACT', 'BUY', 'SUBSCRIBE', 'DOWNLOAD', 'OTHER');

-- CreateEnum
CREATE TYPE "CtaStatus" AS ENUM ('SUGGESTED', 'TRACKED', 'IGNORED');
...
CREATE TABLE "sites" (
    ...
    "checkin7AcknowledgedAt" TIMESTAMP(3),
    "checkin14AcknowledgedAt" TIMESTAMP(3),
    "lastDeepCrawlAt" TIMESTAMP(3),
    ...
    "gadsConnected" BOOLEAN NOT NULL DEFAULT false,
    "gadsCustomerId" TEXT,
    "gadsConnectedAt" TIMESTAMP(3),
    "gadsLastSyncAt" TIMESTAMP(3),
    "gadsConnectedByUserId" TEXT,
    "ga4Connected" BOOLEAN NOT NULL DEFAULT false,
    "ga4PropertyId" TEXT,
    "ga4ConnectedAt" TIMESTAMP(3),
    "ga4LastSyncAt" TIMESTAMP(3),
    "ga4ConnectedByUserId" TEXT,
...
CREATE TABLE "visitor_sessions" (
    ...
    "resolvedAdGroupId" TEXT,
    "gclidResolvedAt" TIMESTAMP(3),
    "gclidResolutionStatus" TEXT,
    "utmCampaignIsStale" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "seo_crawls" (
    ...
    "isDeepCrawl" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateTable
CREATE TABLE "site_ctas" (
    "id" TEXT NOT NULL,
    "siteId" TEXT NOT NULL,
    "competitorUrl" TEXT NOT NULL DEFAULT '',
    "ctaText" TEXT NOT NULL,
    "ctaHref" TEXT NOT NULL DEFAULT '',
    "ctaType" "CtaType" NOT NULL DEFAULT 'OTHER',
    "pages" TEXT[] DEFAULT ARRAY[]::TEXT[],
    "pageCount" INTEGER NOT NULL DEFAULT 0,
    "status" "CtaStatus" NOT NULL DEFAULT 'SUGGESTED',
    "firstDetectedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "lastDetectedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "site_ctas_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "visitor_sessions_siteId_clickIdType_gclidResolvedAt_idx" ON "visitor_sessions"("siteId", "clickIdType", "gclidResolvedAt");
...
-- CreateIndex
CREATE INDEX "site_ctas_siteId_status_idx" ON "site_ctas"("siteId", "status");

-- CreateIndex
CREATE INDEX "site_ctas_siteId_ctaType_idx" ON "site_ctas"("siteId", "ctaType");

-- CreateIndex
CREATE INDEX "site_ctas_siteId_competitorUrl_idx" ON "site_ctas"("siteId", "competitorUrl");

-- CreateIndex
CREATE UNIQUE INDEX "site_ctas_siteId_competitorUrl_ctaText_ctaHref_key" ON "site_ctas"("siteId", "competitorUrl", "ctaText", "ctaHref");

-- CreateIndex
CREATE INDEX "stale_utm_campaigns_siteId_lastSeenAt_idx" ON "stale_utm_campaigns"("siteId", "lastSeenAt");

-- CreateIndex
CREATE UNIQUE INDEX "stale_utm_campaigns_siteId_utmCampaign_key" ON "stale_utm_campaigns"("siteId", "utmCampaign");
...
-- AddForeignKey
ALTER TABLE "site_ctas" ADD CONSTRAINT "site_ctas_siteId_fkey" FOREIGN KEY ("siteId") REFERENCES "sites"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "stale_utm_campaigns" ADD CONSTRAINT "stale_utm_campaigns_siteId_fkey" FOREIGN KEY ("siteId") REFERENCES "sites"("id") ON DELETE CASCADE ON UPDATE CASCADE;
